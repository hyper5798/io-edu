            ...
            <ul class="navbar-nav ml-auto ml-md-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        <!--<a target="_blank" class="dropdown-item" href="https://yesio.net/yesiodocs">使用手冊</a>
                        ...
                        @if($user->role_id < 3)
                        <!--<a class="dropdown-item" href="/node/commands">命令 <span class="sr-only">(current)</span></a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="/node/commandList">命令列表 <span class="sr-only">(current)</span></a>
                                <div class="dropdown-divider"></div>-->
