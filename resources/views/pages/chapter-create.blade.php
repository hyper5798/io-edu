    ...
    <div class="row justify-content-center main-content">
        ...
        <div class="col-6 col-sm-6 col-md-8 col-lg-9">
            <div class="card shadow-lg border-0 rounded-lg mt-2">
                ...
                <div class="card-body">
                    <form method="post" id="chapter_store" action="/admin/chapter/store">
                        ...
                        <div class="form-row">
                            ...
                            <div class="input-group mb-1 col-3 col-sm-3 col-md-3 col-lg-3">
                                <div class="input-group-prepend">
                            ...
                            <div class="input-group mb-1 col-9 col-sm-9 col-md-9 col-lg-9">
                                <div class="input-group-prepend">
                                ...
                                <a href="{{ url('admin/video/create?category_id='.$category_id.'&course_id='.$course_id.'&sort='.$sort) }}" class="form-control">新增影片</a>
                            </div>
                            <div class="input-group mb-1 col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="input-group-prepend">
                            ...
                            <div class="input-group mb-3 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <input type="text" class="form-control"id="image_url2" name="image_url" placeholder="請先上傳圖片" disabled>
                            </div>



                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary float-right">{{__('layout.submit')}}</button>
                                <button type="button" class="btn btn-secondary mr-2 float-right" onclick="toSubmit();">{{__('layout.back')}}</button>
...
@section('footerScripts')
    ...
    <script>
        ...
        function uploadImage() {
            ...
            //let data = {img: upload_url, option: ('c'+category_id) , token:token, file_name:file_name, XDEBUG_SESSION_START:'PHPSTORM'};
        ...
        function toSubmit(){
            ...
            document.getElementById('chapter_store').submit();
        }
