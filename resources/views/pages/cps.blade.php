    ...
    <div class="row breadcrumb">
        <div class="col-md-3">
            ...
            <!--<li class="breadcrumb-item">{{__('layout.management') }}</li> -->
                <li class="breadcrumb-item active" aria-current="page">{{__('layout.cps') }}</li>
            </ol>
        </div>
        <div class="col-md-6 text-center">
            @if($roles != null)
                {{__('layout.roles') }}
                <select onchange="location.href='cps?role_id='+this.options[this.selectedIndex].value">
    ...
    <div v-show="!isNew" class="main-content">
        <table id ="table1"  class="table table-striped table-hover">
            ...
            <tr>
                ...
                <th >{{__('layout.company')}}</th>
                <th >{{__('layout.telephone')}}</th>
                <th >{{__('layout.address')}}</th>
        ...
        <div class="col-lg-12">
            <div class="card shadow-lg border-0 rounded-lg mt-2">
                <div  class="card-header">
                    <!-- edit company data -->
                    <h3 v-if="cp.id>0" class="text-center font-weight-light my-4">
                        ...
                        <div class="form-row">
                            <div class="input-group mb-3 col-md-5">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroup-sizing-default" >{{__('layout.company')}}</span>
                                </div>
                            ...
                            <div class="input-group mb-3 col-md-3">
                                ...
                                <!--<input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" v-model="cp.role_id" name="role_id">-->
                                <select v-model="cp.role_id">
                            ...
                            <!--<div class="input-group mb-3 col-md-6">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroup-sizing-default">日    期</span>
                                </div>
                                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" v-model="cp.updated_at" disabled>
                            </div>-->
                            <div class="col-md-12">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{__('layout.delete_confirm')}} @{{cp.cp_name}} ?
                </div>
...
@section('footerScripts')
    ...
    <script src="{{asset('js/cps.js')}}"></script>
@endsection
