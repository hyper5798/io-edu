    ...
    <div class="row justify-content-center main-content">
        <div class="col-lg-12">
            <div class="card shadow-lg border-0 rounded-lg mt-2">
                ...
                <div class="card-body">
                    <form method="post" action="{{route('admin.chapter.update',[$chapter->id])}}">
                        ...
                        <div class="form-row">
                            ...
                            <div class="input-group mb-1 col-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroup-sizing-default" >
                                        ...
                                        <a href="{{ url('admin/video/create?category_id='.$category_id.'&course_id='.$course_id.'&sort='.$chapter->sort) }}" class="btn btn-primary btn-sm">新增</a>
                                    </span>
                                </div>
                            ...
                            <div class="input-group mb-1 col-12 col-sm-12 col-md-12 col-lg-12">
                                <textarea id="content" name="content" style="width: 100%;height: 500px;">{{$chapter->content}}</textarea>
                            </div>
