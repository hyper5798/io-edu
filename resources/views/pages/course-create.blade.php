    ...
    <div class="row breadcrumb">
        <div class="col-md-9">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/admin/courses?category_id={{$category_id}}">編輯課程</a></li>
    ...
    <div v-show="isNew" class="row justify-content-center main-content">
        <div class="col-lg-12">
            <div class="card shadow-lg border-0 rounded-lg mt-2">
                ...
                <form method="post" id="course_store" action="/admin/course/store">
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="input-group mb-1 col-6 col-sm-6 col-md-6 col-lg-6">
                                            ...
                                            <input type="text" class="form-control" name="freeChapterMax" value="{{$free_chapter}}">
                                        </div>
                                        <div class="input-group mb-1 col-6  col-sm-6 col-md-6 col-lg-6">
                                            <div class="input-group-prepend">
                                        ...
                                        <div class="input-group mb-1 col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <input type="text" class="form-control" name="content_small">
                                        </div>
...
@section('footerScripts')
    ...
    <script>
        ...
        function toSubmit(){
            ...
            document.getElementById('course_store').submit();
        }
