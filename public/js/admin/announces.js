...
let app = new Vue({
    ...
    data: {
        ...
        editPoint: -1,
        delPoint: -1,
        announce: JSON.parse(JSON.stringify(empty))
    },
    methods: {
        newCheck: function () {
            /*this.isNew = true;
            ...
            let newUrl = "/admin/question/create?field_id=";
            document.location.href = newUrl;
        },
        editCheck: function (index) {
            this.editPoint = index;
            this.isNew = true;
            this.announce = this.questionList[index];
        ...
        delCheck: function (index) {
            ...
            this.announce = this.announceist[index];
            $('#myModal').modal('show');
